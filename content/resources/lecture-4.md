...
related_resources_text: "Lecture notes ([PDF](resources/6002_l4 \"Open in a new window.\"\
  ))  \nDemonstration: Superposition using resistors ([PDF](resources/demo_05 \"Open\
  \ in a new window.\"))  \nDemonstration: AND gate output, noise ([PDF](resources/demo_05a\
